...
vcfs=read_tsv("/atium/Data/NGS/Aligned/161027_SSSSS/SPAdes/P_2016_12_13_114033272922/3ref_snp_copy.vcf")
#vcfs=read_tsv("/atium/Data/NGS/Aligned/161027_SSSSS/SPAdes/P_2016_12_02_130357018963/out.vcf")
#vcfs=read_tsv("/atium/Data/NGS/Aligned/161027_SSSSS/SPAdes/P_2016_12_05_231905287037/SNP_3ref_copy.vcf")
...
comp=as_data_frame(t(combn(names(vcfs[10:24]),2))) %>%
    mutate(val=colSums(abs(vcfs[comp$V1]-vcfs[comp$V2])))

comp=rbind(comp, data_frame(V1=comp$V2, V2=comp$V1, val=comp$val))

##write_csv(spread(comp, V2, val), "/atium/Data/NGS/Aligned/161027_SSSSS/SPAdes/testsnp.csv")

write_csv(spread(comp,V2,val), "/atium/Data/NGS/Aligned/161027_SSSSS/SPAdes/3ref_SNP_121316.csv")
