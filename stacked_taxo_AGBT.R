...
#plotdir="/atium/Data/NGS/Aligned/170112_VRE"


comp.krak="/atium/Data/NGS/Aligned/170112_VRE/compare"
plotdir="/atium/Data/NGS/Aligned/170112_VRE/compare_CARD"
samp.list=c("VRENC_withhuman","VRENC_nanopore", "VRE7_withhuman", "VRE7_nanopore","VRE10_withhuman","VRE10_nanopore")
...
krak.report=bind_rows(lapply(samp.list, function(x) {tbl_df(data.frame(read.delim(
                                                         file.path(comp.krak, paste0(x, ".kraken.output")),
...
##Italize bacteria
pdf(file.path(plotdir, "stack_compare.pdf"), width=11, height=8.5)
